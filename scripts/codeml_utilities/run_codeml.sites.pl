...
my $m01a2a378 = " 
 ...
 outfile = $prefix.mlc-M01a2a378.txt * main result file name
 ...
 NSsites = 0 1 2 3 7 8 * 0:one w;1:neutral;2:selection; * 3:discrete;4:freqs; * 5:gamma;6:2gamma;7:beta;8:beta&w;9:beta&gamma;
