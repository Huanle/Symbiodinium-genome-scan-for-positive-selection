...
# if you are a familiar with perl, some perl modules are available for you to do it quickly. http://bioperl.org/howtos/PAML_HOWTO.html
# if you are familiar with python. Congrates, it seems even easier: http://biopython.org/wiki/PAML
